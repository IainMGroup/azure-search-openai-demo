    ...
    return (
        <div className={styles.container}>
            <div className={styles.commandsContainer}>
                ...
                {/*} <SettingsButton className={styles.commandButton} onClick={() => setIsConfigPanelOpen(!isConfigPanelOpen)} /> width="325px" height="150px"  */}
            </div>
            <div className={styles.chatRoot}>
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <img src={waterlogo} alt="Water Logo" aria-label="" className={styles.WaterLogo} />
                            <h1 className={styles.chatEmptyStateTitle}>This is Magi for Water Services</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Ask a question or try an example</h2>
