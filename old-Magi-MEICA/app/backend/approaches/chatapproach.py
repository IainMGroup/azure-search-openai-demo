...
class ChatApproach(Approach, ABC):
    ...
    query_prompt_few_shots = [
        {"role": USER, "content": "Tell me about M Group Services?"},
        {"role": ASSISTANT, "content": "Summarize company information for M Group Services?"},
        {"role": USER, "content": "Tell me about BYOD?"},
        {"role": ASSISTANT, "content": "Show available information for BYOD"},
    ]
    NO_RESPONSE = "0"

    follow_up_questions_prompt_content = """Generate 3 very brief follow-up questions that the user would likely ask next.
    Enclose the follow-up questions in double angle brackets. Example:
    <<Can I use and Andriod phone for BYOD?>>
    <<Is my iPhone compatible with BYOD?>>
    <<Can I get my email using BYOD?>>
