...
class ChatReadRetrieveReadApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
         ...
         If you can't find the answer in the source document then you don't know. Any information to be presented in a table should be formatted in HTML, do not use mark down language.
