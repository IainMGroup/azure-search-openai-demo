...
import telecomslogo from "../../assets/telecomslogo.png";
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <img src={telecomslogo} alt="Telecoms Logo" aria-label="" width="300px" height="150px" className={styles.TelecomsLogo} />
                            <h1 className={styles.chatEmptyStateTitle}>This is Magi for Telecoms Division</h1>
